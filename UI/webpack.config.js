    ...
    rules: [
      ...
      },
      {
        ...
        use: [
          ...
          {
            loader: "sass-loader",
            // sass-loader 13 beherrscht die moderne API bereits. Ohne diese
            // Zeile meldet Dart Sass 1.90 bei jedem Mod-Build exakt 1
            // Legacy-Warnung, obwohl SCSS und Ausgabe fehlerfrei sind.
            options: { api: "modern" },
          },
        ],
      },
